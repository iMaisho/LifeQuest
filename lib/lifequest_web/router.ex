defmodule LifequestWeb.Router do
  use LifequestWeb, :router

  import LifequestWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {LifequestWeb.Layouts, :root}
  ...
  # scope "/api", LifequestWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:lifequest, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: LifequestWeb.Telemetry
  ...
  scope "/", LifequestWeb do
    ...
    live_session :require_authenticated_user,
      ...
      live "/investments", InvestmentsLive.Index, :index

      live "/goals", GoalsLive.Index, :index
    end
  ...
  scope "/", LifequestWeb do
    ...
    live_session :current_user,
      on_mount: [{LifequestWeb.UserAuth, :mount_current_scope}] do
