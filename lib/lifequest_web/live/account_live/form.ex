defmodule LifequestWeb.AccountLive.Form do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      ...
      <.form for={@form} id="account-form" phx-change="validate" phx-submit="save">
        ...
        <.input
          ...
          options={Ecto.Enum.values(Lifequest.Finances.Account, :type)}
        />
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(:form, to_form(Finances.change_account(socket.assigns.current_scope, account)))
  end

  defp apply_action(socket, :new, _params) do
    account = %Account{user_id: socket.assigns.current_scope.user.id}
  ...
  defp save_account(socket, :new, account_params) do
    case Finances.create_account(socket.assigns.current_scope, account_params) do
      {:ok, account} ->
        {:noreply,
         socket
